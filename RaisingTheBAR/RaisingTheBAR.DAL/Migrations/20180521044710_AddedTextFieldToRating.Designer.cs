...
namespace RaisingTheBAR.DAL.Migrations
{
    ...
    [Migration("20180521044710_AddedTextFieldToRating")]
    partial class AddedTextFieldToRating
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RaisingTheBAR.Core.Models.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("RaisingTheBAR.Core.Models.Rating", b =>
                {
                    b.Property<Guid>("OrderId");
            ...
            modelBuilder.Entity("RaisingTheBAR.Core.Models.Rating", b =>
                {
                    b.HasOne("RaisingTheBAR.Core.Models.Order", "Order")
                        .WithOne("Rating")
                        .HasForeignKey("RaisingTheBAR.Core.Models.Rating", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
